...
def logs(str):
    ...
    lirun=open('D034C00_user_ota.log','a+')
...
def result1():
    ...
    if pidota.find("com.android.ota") != -1:
        ...
        if res1.find("Start proc com.android.ota for service com.android.ota/.PullUpService") != -1:
            ...
            if res1.find("start ota") == -1:
                return "watchdog"

        if res1.find("Start proc com.android.ota for broadcast com.android.ota/.udisk.UDiskReceiver") != -1 and res1.find("start ota") == -1 and res1.find("act=com.roobo.ota.PULL_UP") == -1:
