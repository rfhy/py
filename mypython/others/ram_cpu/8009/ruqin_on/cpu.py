...
def Logfile(str):
    ...
    lirun = open(curtime + "_top_cpu.txt","a+")
...
if __name__ == '__main__':
    ...
    #mem = ['com.roobo.ioe.smartcontrol','/system/bin/mediaserver']
    mem = ['com.roobo.ioe.smartac.gree','/system/bin/mm-qcamera-daemon','/system/bin/mediaserver','/system/bin/surfaceflinger','system_server']
