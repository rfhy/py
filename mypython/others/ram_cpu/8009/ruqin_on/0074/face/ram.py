...
pid = 'com.huaa.demo.camera.cameracodedemo'
    ...
    if ram.find("Used RAM:") != -1:
        ...
        try:
            ...
            for s in range(0,len(item)):
                ...
                strs.append(line[s - 6].split(": ")[1].split(" (")[0])#PD801-8,8009:-6

                print (line[s-6].split('\r\n')[0])
