...
def cljshutdown():
	...
	test_shutdown = {"action": "DeviceManager/Shutdown","data": {"mainctl": "1011000000111007","restart":"true","timer":"10","slient":"false","myid" : "ps:f8e04e665c95bddc1865b1ca975eb0c3","token":accesstoken}}
	jdata = json.dumps(test_shutdown) 
	...
	try:
		...
		res = res_data.read()
		print "Pudding reboot ",res
		if ':0' in res:
			print 'Passed:Pudding reboot successed ';
			return True
		else:
			print 'Failed:error msg: Pudding reboot failed, please check Pudding reboot';
			return False
		res_data.close();	
