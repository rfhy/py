...
def cljdetection():
	...
	test_detection = {"action": "VideoMaster/moveDetection","data": {"mainctl": "1011000000111007","status":1,"myid" : "ps:f8e04e665c95bddc1865b1ca975eb0c3","token":accesstoken}}
	...
	try:
		...
		res = res_data.read()
		print "Dynamic Detection status is 1",res
		if '9999' in res:
			print 'Passed:Set status 1 successed ';
		else:
			print 'Failed:error msg: Set status 1 failed, please check Dynamic Detection';
			return False
		res_data.close();	
	...
	test_detection = {"action": "VideoMaster/moveDetection","data": {"mainctl": "1011000000111007","status":0,"myid" : "ps:f8e04e665c95bddc1865b1ca975eb0c3","token":accesstoken}}
	jdata = json.dumps(test_detection) 
	req = urllib2.Request(requrl,jdata)
	print req
	...
	try:
		res_data = urllib2.urlopen(req)
		res = res_data.read()
		print "Dynamic Detection status is 0",res
		if '9999' in res:
			print 'Passed:Set status 0 successed ';
			return True
		else:
			print 'Failed:error msg: Set status 0 failed, please check Dynamic Detection';
			return False
		res_data.close();	
