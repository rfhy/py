...
def result1():
    ...
    if pidota.find("com.android.ota") != -1:
        ...
        elif res1.find("boot start ota") != -1:

            logs("boot start ota")
            
            return "boot"

        elif res1.find("Start proc com.android.ota for service com.android.ota/.PullUpService") != -1 and res1.find("coreserver start ota") == -1:

            logs("Start proc com.android.ota for service com.android.ota/.PullUpService")

            return "watchdog"

        elif res1.find("Start proc com.android.ota for broadcast com.android.ota/.udisk.UDiskReceiver") != -1 and res1.find("boot start ota") == -1 and res1.find("act=com.roobo.ota.PULL_UP") == -1 and res1.find("coreserver start ota") == -1:
